...
While global assembly is essential for multi-part objects, its performance depends heavily on the accuracy of the underlying pairwise matches. Therefore, this work focuses on the simplified case of two-piece assembly. By isolating the pipeline from the error-correcting safety net of global optimization, the study isolates and targets the core challenge of accurate pairwise alignment, particularly in learning robust local geometric features and attention mechanisms.
